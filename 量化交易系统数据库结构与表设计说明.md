...
**主键**：creator_name, param_id

**示例数据：**

| creator_name | param_id     | data_id              | param_type | pre_period | post_period | agg_func |
| ------------ | ------------ | -------------------- | ---------- | ---------- | ----------- | -------- |
...
**主键**：indicator_creator_name, indicator_name, param_creator_name, param_id

**示例数据（MACD指标参数关系）：**

| indicator_creator_name | indicator_name | param_creator_name | param_id     |
| ---------------------- | -------------- | ------------------ | ------------ |
...
**主键**：strategy_creator_name, strategy_name, param_creator_name, param_id

**示例数据（所有策略参数关系）：**

| strategy_creator_name | strategy_name | param_creator_name | param_id   |
| --------------------- | ------------- | ------------------ | ---------- |
